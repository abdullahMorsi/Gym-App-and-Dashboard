                                ...
                                <form method="post" action="/admin/book/{{$book->id}}" enctype="multipart/form-data" >
                                    ...
                                    <div class="">
                                        <div class="form-group">
                                            ...
                                            <input name="name" type="text" class="form-control" placeholder="Enter Book Name" value="{{$book->name}}">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Link</label>
                                            <input name="link" type="text" class="form-control" placeholder="Enter Link" value="{{$book->link}}">
                                        </div>
                                        <div class="form-group">
